...
function updateURL() {
  history.pushState(null, null, "/?"+(action=="buy"? "":"action="+action+"&")+"symbol1="+symbol1+(issuer1=="" || symbol1==""? "":"."+issuer1)+($("#qty1").val()==""? "":"&qty1="+$("#qty1").val())+(action=="send"? ($("#recipient").val()==""? "":"&recipient="+$("#recipient").val()):"&symbol2="+symbol2+(issuer2=="" || symbol2==""? "":"."+issuer2)+($("#price").val()!=""? "&price="+$("#price").val():"")));
}
...
function getAllDisplayNames(exitFunction, startIndex) {
  ...
  .then(function (transactions) {
    ...
    console.log("getAllDisplayNames retrieval error: "+err);
    exitFunction();
  });
}
...
function parseLinks(text) {
    ...
    return text.replace(urlRegex, function(url) {
        return '<a href="' + url + '" target="_blank">' + shortenLink(url) + '</a>';
    })
...
function printChat(msg) {
  ...
  //console.log(msg);
  $("#chatHistoryContents").append("<br />"+parseLinks(msg));
