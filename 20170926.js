                ...
                api.preparePayment(address, payment, options).then(function(prepared)
                  {
                    ...
                    if(transaction!="") {
                      api.submit(transaction).then(function(result) {
                        ...
                        else if(result.resultCode=="tecUNFUNDED_PAYMENT") $("#errors").html("Send failed due to lack of funds available (or frozen by issuer).");
            ...
            api.prepareOrder(address, order, options).then(function(prepared)
              {
                ...
                if(transaction!="") {
                  api.submit(transaction).then(function(result) {
                    ...
                    else if(result.resultCode=="tecUNFUNDED_OFFER") $("#errors").html("Order failed due to lack of funds available (or frozen by issuer).");
